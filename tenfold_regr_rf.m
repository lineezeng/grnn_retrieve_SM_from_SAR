...
x9=[lns,lnl,vv,hv];
x10=[lns,lnl,vh,hv];
x11=[lns,lnl,hh,vv,hv];
x12=[lns,lnl,hh,vv,vh];  
x13=[lns,lnl,hh,hv,vh];
x14=[lns,lnl,vv,hv,vh];  
x15=[lns,lnl,hh,vv,hv,vh];  
...
xlswrite('10 fold nonlingress with rough.xlsx',croval);
